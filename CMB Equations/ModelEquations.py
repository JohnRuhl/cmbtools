...
def dustSignal(parameters, inputs, tuning=5300.*1.15):
    ...
    # making dust model
    dustSignal = [(ampl)*(tuning*10.**(-20.))*prefactor*dust(l) for l in lList]  # *** multiplying by the constant in temporary. Also is list comprehension necessary if numpy arrays? ***
